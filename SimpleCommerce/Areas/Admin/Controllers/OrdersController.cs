...
namespace SimpleCommerce.Areas.Admin.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CreateDate,Owner,CartId,CustomerId,OrderStatus")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CreateDate,Owner,CartId,CustomerId,OrderStatus")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
